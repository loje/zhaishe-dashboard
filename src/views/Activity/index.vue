      ...
      <el-table
        ...
        <el-table-column
          ...
          <template slot-scope="scope">
            ...
            <template v-else><span style="color:#999;">未设置可报名人数</span></template>
          </template>
        </el-table-column>
        ...
        <el-table-column
          ...
          <template slot-scope="scope">
            ...
            <div class="state" v-else-if="new Date(scope.row.endTime).getTime() > Date.now() && new Date(scope.row.startTime).getTime() < Date.now()">
